...
<link href="<?php echo ADMINVIEW . '/cache/' . Cache::cssCache(array('base.css','transition.css','dropdown.css','menu.css','image.css','label.css','message.css','list.css','table.css','datepicker.css','divider.css','form.css','input.css','icon.css','button.css','segment.css','popup.css','dimmer.css','modal.css','progress.css','utility.css','style.css'), ADMINBASE);?>" rel="stylesheet" type="text/css" />
...
<aside> <a id="mnav-alt"><i class="icon reorder"></i></a> <a href="<?php echo ADMINURL;?>/" class="logo"><?php echo (App::Core()->logo) ? '<img src="' . SITEURL . '/uploads/' . App::Core()->logo . '" alt="'.App::Core()->company . '">': App::Core()->company;?></a>
  <div class="menuwrap">
    <nav>
      <ul>
        <li<?php if (count($this->segments) == 1) echo ' class="active"';?>><a href="<?php echo ADMINURL;?>"><img src="<?php echo ADMINVIEW;?>/images/dash.png"> <span><?php echo Lang::$word->ADM_DASH;?></span></a></li>
        <li<?php if (Utility::in_array_any(["templates","countries","coupons","fields","news","mailer"], $this->segments)) echo ' class="active"';?>><a class="collapsed"><img src="<?php echo ADMINVIEW;?>/images/content.png"> <span><?php echo Lang::$word->ADM_CONTENT;?></span></a>
          <ul>
        ...
        <li<?php if (in_array("users", $this->segments)) echo ' class="active"';?>><a href="<?php echo Url::url("/admin/users");?>"><img src="<?php echo ADMINVIEW;?>/images/users.png"> <span><?php echo Lang::$word->ADM_USERS;?></span></a></li>
        <li<?php if (in_array("memberships", $this->segments)) echo ' class="active"';?>><a href="<?php echo Url::url("/admin/memberships");?>"><img src="<?php echo ADMINVIEW;?>/images/membership.png"> <span><?php echo Lang::$word->ADM_MEMBS;?></span></a></li>
        <li<?php if (Utility::in_array_any(["configuration","language","backup","gateways","maintenance"], $this->segments)) echo ' class="active"';?>><a class="collapsed"><img src="<?php echo ADMINVIEW;?>/images/settings.png"> <span><?php echo Lang::$word->ADM_CONFIG;?></span></a>
          <ul>
        ...
        <li<?php if (in_array("help", $this->segments)) echo ' class="active"';?>><a href="<?php echo Url::url("/admin/help");?>"><img src="<?php echo ADMINVIEW;?>/images/help.png"> <span><?php echo Lang::$word->ADM_HELP;?></span></a></li>
      </ul>
    </nav>
  </div>
</aside>
