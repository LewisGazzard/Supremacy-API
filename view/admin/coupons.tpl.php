...
<div class="row screen-block-3 tablet-block-2 mobile-block-1 phone-block-1 gutters align-center">
  ...
  <div class="column" id="item_<?php echo $row->id;?>">
    <div class="wojo segment">
      <div class="content-center<?php if($row->active == 0):?> dimmable dimmed<?php endif;?>" id="cpn_<?php echo $row->id;?>"><a href="<?php echo Url::url(Router::$path, "edit/" . $row->id);?>"><img src="<?php echo ADMINVIEW;?>/images/coupon.png" alt=""></a>
