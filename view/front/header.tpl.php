...
<div class="wojo-grid">
<div id="logo"><a href="<?php echo SITEURL;?>/" class="logo"><?php echo (App::Core()->logo) ? '<img src="' . SITEURL . '/uploads/' . App::Core()->logo . '" alt="'.App::Core()->company . '" "For IT Support, Please call 07870352477">': App::Core()->company;?></a></div>
