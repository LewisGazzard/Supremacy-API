...
<div class="clearfix" id="tabs-alt"> <a href="<?php echo Url::url("/dashboard");?>" class="static"> <?php echo Lang::$word->ADM_MEMBS;?></a> <a class="active"><?php echo Lang::$word->HISTORY;?></a> <a class="static" href="<?php echo Url::url("/dashboard/profile");?>"><?php echo Lang::$word->M_SUB18;?></a> </div>
<div class="login-form">
  ...
  <div class="wojo small primary button"><?php echo Lang::$word->TRX_TOTAMT;?> <?php echo Utility::formatMoney(Stats::doArraySum($this->data, "price"));?></div>
  <?php endif;?>
</div>